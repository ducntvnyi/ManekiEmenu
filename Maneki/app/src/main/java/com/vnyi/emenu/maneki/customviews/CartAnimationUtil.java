...
public class CartAnimationUtil {
    ...
    public CartAnimationUtil() {
    }

    public CartAnimationUtil attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public CartAnimationUtil setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private CartAnimationUtil setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private CartAnimationUtil setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public CartAnimationUtil setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public CartAnimationUtil setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public CartAnimationUtil setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public CartAnimationUtil setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public CartAnimationUtil setMoveDuration(int duration) {
...
//            mBitmap = drawViewToBitmap(mTarget, mTarget.getWidth(), mTarget.getHeight());
            mBitmap = ViewUtils.getBitmapFromView(mTarget);
            if (mImageView == null)
...
//        mTarget.setVisibility(View.VISIBLE);
    ...
    public CartAnimationUtil setAnimationListener(Animator.AnimatorListener listener) {
