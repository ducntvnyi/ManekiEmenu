...
public interface CallBack {
    ...
    /**
     * <p> this will be the the first method called by ConnectTaskImpl
     */
    void onConnecting();

    /**
     * <p> if  ConnectTaskImpl is successfully
     ...
     *                       See ConnectTaskImpl#run(). If the value of http header field
