...
public class Email extends javax.mail.Authenticator {
    private String user = "", pass = "", from = "", port = "", sport = "", host = "", subject = "", body = "";
     ...
     * @return
     */
    public static Email getInstance(String user, String pass) {
        return new Email(user, pass);
    }
    ...
    public Email setBody(String _body) {
        this.body = _body;
        return this;
    }

    public Email setTo(String[] _to) {
        this.to = _to;
        return this;
    }

    public Email setFrom(String _from) {
        this.from = _from;
        return this;
    }

    public Email setSubject(String _subject) {
        this.subject = _subject;
        return this;
    }

    public Email setPort(String _port) {
        this.port = _port;
        return this;
    }

    public Email setSport(String sport) {
        this.sport = sport;
        return this;
    }

    public Email setHost(String _host) {
        this.host = _host;
        return this;
    }
