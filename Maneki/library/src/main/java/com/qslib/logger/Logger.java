...
public class Logger {
    ...
    public static void d(String msg) {
        try {
            if (isEnableLog) Log.d(tagDefault, buildMessage(TypeLog.DEBUG, tagDefault, msg));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void d(String tag, String msg) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) d(msg);
                else Log.d(tag, buildMessage(TypeLog.DEBUG, tag, msg));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void d(String tag, Exception ex) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) d(ex);
                else Log.d(tag, buildMessage(TypeLog.DEBUG, tag, getMessageException(ex)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void e(String msg) {
        try {
            if (isEnableLog) Log.e(tagDefault, buildMessage(TypeLog.ERROR, tagDefault, msg));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void e(String tag, String msg) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) e(msg);
                else Log.e(tag, buildMessage(TypeLog.ERROR, tag, msg));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void e(String tag, Exception ex) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) e(ex);
                else Log.e(tag, buildMessage(TypeLog.ERROR, tag, getMessageException(ex)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void i(String tag, String msg) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) i(msg);
                else Log.i(tag, buildMessage(TypeLog.INFO, tag, msg));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void i(String tag, Exception ex) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) i(ex);
                else Log.i(tag, buildMessage(TypeLog.INFO, tag, getMessageException(ex)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void i(String msg) {
        try {
            if (isEnableLog) Log.i(tagDefault, buildMessage(TypeLog.INFO, tagDefault, msg));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void v(String tag, String msg) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) v(msg);
                else Log.v(tag, buildMessage(TypeLog.VERBOSE, tag, msg));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void v(String tag, Exception ex) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) v(ex);
                else Log.v(tag, buildMessage(TypeLog.VERBOSE, tag, getMessageException(ex)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void w(String tag, String msg) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) w(msg);
                else Log.w(tag, buildMessage(TypeLog.WARN, tag, msg));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void w(String tag, Exception ex) {
        try {
            if (isEnableLog) {
                if (StringUtils.isEmpty(tag)) w(ex);
                else Log.w(tag, buildMessage(TypeLog.WARN, tag, getMessageException(ex)));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void w(String msg) {
        try {
            if (isEnableLog) Log.w(tagDefault, buildMessage(TypeLog.WARN, tagDefault, msg));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            if (isEnableLog) {
                ...
                if (!file.getParentFile().exists()) {
                    ...
                    else Log.i(tagDefault, "The \"Log Dir\" was successfully created! -"
                            + file.getParent());
                }
            } else {
