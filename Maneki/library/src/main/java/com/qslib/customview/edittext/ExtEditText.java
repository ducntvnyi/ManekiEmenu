package com.qslib.customview.edittext;
...
import com.qslib.customview.edittext.validators.AlphaNumericValidator;
import com.qslib.customview.edittext.validators.AlphaValidator;
import com.qslib.customview.edittext.validators.CreditCardValidator;
import com.qslib.customview.edittext.validators.DomainValidator;
import com.qslib.customview.edittext.validators.EmailValidator;
import com.qslib.customview.edittext.validators.IpValidator;
import com.qslib.customview.edittext.validators.NumericValidator;
import com.qslib.customview.edittext.validators.OrValidator;
import com.qslib.customview.edittext.validators.PhoneValidator;
import com.qslib.customview.edittext.validators.RegExpValidator;
import com.qslib.customview.edittext.validators.Validator;
import com.qslib.customview.edittext.validators.WebUrlValidator;
        ...
        if (null != this.validators) {
            for (Validator v : this.validators) {
                ...
                if (!b) {
                    ...
                    if (StringUtils.isEmpty(error)) error = this.errorString;
                    if (!StringUtils.isEmpty(error)) {
                        setError(error);
                        requestFocus();
                    }
