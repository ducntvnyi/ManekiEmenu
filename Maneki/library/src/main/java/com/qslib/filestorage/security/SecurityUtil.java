...
public class SecurityUtil {
    ...
    public static byte[] encrypt(byte[] content, int encryptionMode, final byte[] secretKey, final byte[] ivx) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to encrypt/decrypt - Unknown Algorithm", e);
        } catch (NoSuchPaddingException e) {
            throw new RuntimeException("Failed to encrypt/decrypt- Unknown Padding", e);
        } catch (InvalidKeyException e) {
            throw new RuntimeException("Failed to encrypt/decrypt - Invalid Key", e);
        } catch (InvalidAlgorithmParameterException e) {
            throw new RuntimeException("Failed to encrypt/decrypt - Invalid Algorithm Parameter", e);
        } catch (IllegalBlockSizeException | BadPaddingException e) {
            throw new RuntimeException("Failed to encrypt/decrypt", e);
        }
    }
